      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="lg:w-1/2 space-y-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-900/30 border border-blue-500/30 text-blue-400 text-sm font-semibold mb-4">
          ...
          <div className="lg:w-1/2 relative animate-float">
            <div className="relative z-10 bg-[#0f172a] border border-slate-700 rounded-2xl p-2 shadow-2xl neon-glow">
                <img 
                ...
                <div className="absolute -left-8 top-1/4 bg-[#1e293b]/90 backdrop-blur-md border border-blue-500/30 p-4 rounded-lg shadow-xl animate-float" style={{animationDelay: '1s'}}>
                ...
                <div className="absolute -right-8 bottom-1/4 bg-[#1e293b]/90 backdrop-blur-md border border-cyan-500/30 p-4 rounded-lg shadow-xl animate-float" style={{animationDelay: '2s'}}>
                    <div className="flex items-center gap-3">
