...
import { Search, FileText, Zap, FileCheck, Edit3, ShieldAlert, Cpu, BarChart3, BookOpen } from 'lucide-react';
    ...
    <section id="solution" className="py-24 bg-[#020617] relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <motion.div 
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="relative rounded-3xl overflow-hidden border border-gray-800 bg-[#0f172a]"
        >
             {/* Grid Background */}
                 ...
                 <div className="lg:w-2/3 p-10 lg:p-0 relative min-h-[500px] flex items-center justify-center bg-[#0a1022]">
                    ...
                    <div className="relative w-full max-w-2xl h-[400px]">
                        ...
                        <motion.div 
                            ...
                            className="absolute top-1/2 left-4 md:left-12 -translate-y-1/2 w-40 p-4 rounded-xl bg-[#1e293b] border border-blue-500/50 shadow-lg z-20 flex flex-col items-center gap-3"
                        >
                        ...
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-64 z-10">
                            ...
                            <motion.div 
                                ...
                                className="absolute inset-0 rounded-[40px] border-2 border-dashed border-cyan-500/30 animate-spin-slow"
                            ></motion.div>
                            ...
                            <motion.div 
                                ...
                                className="absolute -top-6 left-1/2 -translate-x-1/2 w-32 py-2 px-3 rounded-lg bg-[#0f172a] border border-cyan-500 text-center shadow-[0_0_20px_rgba(6,182,212,0.3)] z-30"
                            >
                            ...
                            <motion.div 
                                ...
                                className="absolute -bottom-6 left-1/2 -translate-x-1/2 w-32 py-2 px-3 rounded-lg bg-[#0f172a] border border-purple-500 text-center shadow-[0_0_20px_rgba(168,85,247,0.3)] z-30"
                            >
                        ...
                        <motion.div 
                            ...
                            className="absolute top-1/2 right-4 md:right-12 -translate-y-1/2 w-40 p-4 rounded-xl bg-[#1e293b] border border-green-500/50 shadow-lg z-20 flex flex-col items-center gap-3"
                        >
                        ...
                        <motion.div 
                            ...
                            className="absolute top-[196px] w-2 h-2 bg-white rounded-full shadow-[0_0_10px_#fff] z-50"
                        />
                    </div>
                 </div>
             </div>
