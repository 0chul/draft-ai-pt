    ...
    <section id="problem" className="py-24 bg-[#050b1d] relative">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-blue-500 font-bold tracking-widest uppercase mb-4">The Problem</h2>
        ...
        {/* Impact Visual */}
        <div className="mt-20 glass-panel p-10 rounded-3xl border border-red-500/20 bg-gradient-to-r from-red-900/10 to-transparent">
            <div className="flex flex-col md:flex-row items-center justify-between gap-10">
                ...
                <div className="flex-1 w-full relative h-4 bg-gray-800 rounded-full overflow-hidden">
                    <div className="absolute left-0 top-0 h-full bg-red-500 w-[85%] animate-pulse"></div>
